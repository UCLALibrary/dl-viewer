...
.mejs__overlay-button {
  width: 80px;
  height: 80px;
  background: url("/mejs/build/mejs-controls.svg") no-repeat;
...
.mejs__overlay-loading-bg-img {
  ...
  width: 80px;
  height: 80px;
  background: transparent url("/mejs/build/mejs-controls.svg") -160px -40px
    no-repeat;
  z-index: 1;
...
.mejs__button > button {
  ...
  background: transparent url("/mejs/build/mejs-controls.svg");
  border: 0;
  cursor: pointer;
  line-height: 0;
}
